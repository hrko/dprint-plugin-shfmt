...
var unusedGlobalMap = map[uint32]uint32{}
...
func get_plugin_info() uint32 {
	return setSharedBytes([]byte(`{"name":"case-syntax-global-map-unused","version":"0.0.0","configKey":"isolation","helpUrl":"https://example.com","configSchemaUrl":""}`))
}
